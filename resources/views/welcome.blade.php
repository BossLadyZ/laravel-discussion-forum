            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/discussion') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Discussions</a>
                @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/discussion') }}"
                                    class="underline text-gray-900 dark:text-white">Discussions</a></div>
                        </div>
